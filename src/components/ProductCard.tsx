...
// Seed data uses placehold.co as a stand-in — treat that as "no real photo
// yet" and render the designed placeholder instead. The moment a real photo
// URL is dropped into products.ts, this automatically switches to it.
...
export default function ProductCard({ product, compact, columns }: Props) {
  ...
  return (
    <TouchableOpacity
      activeOpacity={0.85}
      style={[styles.card, { width: cardWidth }, Platform.OS === 'web' && styles.webHover]}
...
const styles = StyleSheet.create({
  ...
  outOfStockOverlay: {
    ...
    left: 0,
    right: 0,
    backgroundColor: 'rgba(43,35,32,0.72)',
    paddingVertical: 5,
    alignItems: 'center',
  },
